 ...
 */
#include "ff.h"
 typedef struct arm_zjpgd_io_fatfs_file_loader_t {
    const char *pchFilePath;
    FIL *phFile; 
} arm_zjpgd_io_fatfs_file_loader_t;
...
ARM_PRIVATE(
    ...
    arm_zjpgd_io_fatfs_file_loader_t tFatFile;
    arm_zjpgd_io_fatfs_file_loader_t tBGFatFile;
    ref_gui_t *ptGUI;     
};
