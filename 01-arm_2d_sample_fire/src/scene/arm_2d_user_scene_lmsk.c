...
static
bool fatfs_arm_user_io_fopen(uintptr_t pTarget, arm_lmsk_loader_t *ptLoader)
{
    arm_user_io_fatfs_file_loader_t *ptThis = (arm_user_io_fatfs_file_loader_t *)pTarget;
...
static
void fatfs_arm_user_io_fclose(uintptr_t pTarget, arm_lmsk_loader_t *ptLoader)
{
    arm_user_io_fatfs_file_loader_t *ptThis = (arm_user_io_fatfs_file_loader_t *)pTarget;
    ARM_2D_UNUSED(ptLoader);
    assert(NULL != ptThis);
...
static
bool fatfs_arm_user_io_fseek(uintptr_t pTarget, arm_lmsk_loader_t *ptLoader, int32_t offset, int32_t whence)
{
    arm_user_io_fatfs_file_loader_t *ptThis = (arm_user_io_fatfs_file_loader_t *)pTarget;
    ARM_2D_UNUSED(ptLoader);
    assert(NULL != ptThis);
...
static
size_t fatfs_arm_user_io_fread(uintptr_t pTarget, arm_lmsk_loader_t *ptLoader, uint8_t *pchBuffer, size_t tSize)
{
    arm_user_io_fatfs_file_loader_t *ptThis = (arm_user_io_fatfs_file_loader_t *)pTarget;
    ARM_2D_UNUSED(ptLoader);
    assert(NULL != ptThis);
...
static
const arm_loader_io_t ARM_USER_IO_FILE_LOADER_FATFS = {
    .fnOpen =   &fatfs_arm_user_io_fopen,
    .fnClose =  &fatfs_arm_user_io_fclose,
    .fnSeek =   &fatfs_arm_user_io_fseek,
    .fnRead =   &fatfs_arm_user_io_fread,
};
...
ARM_NONNULL(1, 2)
arm_2d_err_t arm_user_io_fatts_file_loader_init(arm_user_io_fatfs_file_loader_t *ptThis, 
                                           const char *pchFilePath)
{
    ...
    memset(ptThis, 0, sizeof(arm_user_io_fatfs_file_loader_t));
                                        ...
                                        user_scene_lmsk_t *ptThis)
{
    ...
    *ptThis = (user_scene_lmsk_t){
    ...
    do {
        ...
        arm_user_io_fatts_file_loader_init(&this.tUserFile, 
                                "bad_apple.lmsk");
    #else
        ...
        #if ARM_2D_DEMO_LMSK_USE_FILE && __ARM_LMSK_USE_LOADER_IO__
            .ImageIO = {
                .ptIO = &ARM_USER_IO_FILE_LOADER_FATFS,
                .pTarget = (uintptr_t)&this.tUserFile,
            },
    ...
    this.tFilm = (arm_2d_helper_film_t)impl_film(this.LMSK.tLoader, 100, 75, 16,3110, 33);
