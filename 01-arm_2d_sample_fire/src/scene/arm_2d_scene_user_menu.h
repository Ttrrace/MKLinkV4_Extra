...
ARM_PRIVATE(
    ...
    int16_t             iProgress[3];
    bool                bMenuOpened;
    bool                bIsMenuSlideEnd;
    bool                bShowModel;
    bool                bFirstShowModel;
    bool                bShowQR;
    arm_2d_user_draw_line_descriptor_t data_line[4];
    uint8_t             chPT;
    uint8_t             chState;
    uint8_t             chState1;
    uint8_t             chState2;
    ...
    foldable_panel_t    tPanel[2];
    arm_2d_helper_dirty_region_item_t tDirtyRegionItem[4];
    arm_2d_op_trans_opa_t  s_tOP[3]; 
