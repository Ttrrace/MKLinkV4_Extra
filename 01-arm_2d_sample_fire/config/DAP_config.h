...
#define CPU_CLOCK               140000000U      ///< Specifies the CPU Clock in Hz.
...
#define PIN_TDO                         IOC_PAD_PB14
#define PIN_nRESET                      IOC_PAD_PY00

#define PIN_TMS_DIR_NUM      15
#define PIN_TCK_NUM          12
#define PIN_TMS_NUM          11
#define PIN_TDI_NUM          13
#define PIN_TDO_NUM          14
#define PIN_RST_NUM          0
#endif
...
__STATIC_INLINE void PORT_JTAG_SETUP (void) {
    ...
    gpiom_set_pin_controller(HPM_GPIOM, GPIOM_ASSIGN_GPIOY, PIN_RST_NUM, gpiom_soc_gpio0);
    ...
    gpio_set_pin_output_with_initial(HPM_GPIO0, GPIO_OE_GPIOY, PIN_RST_NUM, true);
    ...
    HPM_IOC->PAD[PIN_nRESET].PAD_CTL = IOC_PAD_PAD_CTL_PRS_SET(1) | IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1) | IOC_PAD_PAD_CTL_SR_SET(1) | IOC_PAD_PAD_CTL_SPD_SET(3)| IOC_PAD_PAD_CTL_DS_SET(0) ;
...
__STATIC_INLINE void PORT_SWD_SETUP (void) {
    ...
    HPM_IOC->PAD[PIN_nRESET].PAD_CTL = IOC_PAD_PAD_CTL_PRS_SET(1) | IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1) | IOC_PAD_PAD_CTL_SPD_SET(3)| IOC_PAD_PAD_CTL_DS_SET(0);
    HPM_IOC->PAD[SWDIO_DIR].PAD_CTL = IOC_PAD_PAD_CTL_PRS_SET(1) | IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1) | IOC_PAD_PAD_CTL_SR_SET(1) | IOC_PAD_PAD_CTL_SPD_SET(3)| IOC_PAD_PAD_CTL_DS_SET(0) ;
}
...
__STATIC_INLINE void PORT_OFF (void) {
    ...
    gpio_disable_pin_interrupt(PIN_GPIO, GPIO_IE_GPIOB, PIN_TCK_NUM);
    gpiom_set_pin_controller(HPM_GPIOM, GPIOM_ASSIGN_GPIOB, PIN_TCK_NUM, gpiom_soc_gpio0);

    gpio_set_pin_input(PIN_GPIO, PIN_PORT, PIN_TMS_NUM);
    gpio_disable_pin_interrupt(PIN_GPIO, GPIO_IE_GPIOB, PIN_TMS_NUM);
    gpiom_set_pin_controller(HPM_GPIOM, GPIOM_ASSIGN_GPIOB, PIN_TMS_NUM, gpiom_soc_gpio0);

    gpio_set_pin_input(PIN_GPIO, PIN_PORT, PIN_TDI_NUM);
    gpio_disable_pin_interrupt(PIN_GPIO, GPIO_IE_GPIOB, PIN_TDI_NUM);
    gpiom_set_pin_controller(HPM_GPIOM, GPIOM_ASSIGN_GPIOB, PIN_TDI_NUM, gpiom_soc_gpio0);

    gpio_set_pin_input(PIN_GPIO, PIN_PORT, PIN_TDO_NUM);
    gpio_disable_pin_interrupt(PIN_GPIO, GPIO_IE_GPIOB, PIN_TDO_NUM);
    gpiom_set_pin_controller(HPM_GPIOM, GPIOM_ASSIGN_GPIOB, PIN_TDO_NUM, gpiom_soc_gpio0);
...
__STATIC_FORCEINLINE uint32_t PIN_TDI_IN  (void) {
    uint32_t sta =  gpio_get_pin_output_status(PIN_GPIO, PIN_PORT, PIN_TDI_NUM);
    __asm volatile("fence io, io");
    return sta;
}
...
__STATIC_FORCEINLINE uint32_t PIN_nRESET_IN  (void) {
    uint32_t sta =  gpio_get_pin_output_status(HPM_GPIO0, GPIO_DO_GPIOY, PIN_RST_NUM);
    __asm volatile("fence io, io");
    return sta;
}
...
__STATIC_FORCEINLINE void     PIN_nRESET_OUT (uint32_t bit) {
    ...
    if(bit & 0x01) {
       gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOY, PIN_RST_NUM, true);
    }
    else {
       gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOY, PIN_RST_NUM, false);
