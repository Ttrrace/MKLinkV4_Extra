...
/* Basic operations */
#define ST7789_Delayms(_mS) clock_cpu_delay_ms(_mS)
#define ST7789_Delayus(_uS) clock_cpu_delay_us(_uS)
#define ST7789_RST_Clr() 
#define ST7789_RST_Set() 
#define ST7789_LED_SET()gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOA, 26, 1);
#define ST7789_DC_Clr() gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOA, 6, 0);
#define ST7789_DC_Set() gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOA, 6, 1);
#ifndef CFG_NO_CS
#define ST7789_Select()// gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOA, 3, 0);
#define ST7789_UnSelect()// gpio_write_pin(HPM_GPIO0, GPIO_DO_GPIOA, 3, 1);
#else
