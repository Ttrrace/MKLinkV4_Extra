...
#define BOARD_RT_CONSOLE_BASE        HPM_UART0
#define BOARD_RT_CONSOLE_CLK_NAME    clock_uart0
#define BOARD_RT_CONSOLE_IRQ         IRQn_UART0
...
#define BOARD_EN_GPIO_INDEX GPIO_DO_GPIOY
#define BOARD_EN_GPIO_PIN   1
...
#define BOARD_LCD_SPI_BASE              HPM_SPI0
#define BOARD_LCD_SPI_CLK_NAME          clock_spi0
#define BOARD_LCD_SPI_IRQ               IRQn_SPI0
#define BOARD_LCD_SPI_SCLK_FREQ         (20000000UL)
#define BOARD_LCD_SPI_ADDR_LEN_IN_BYTES (1U)
#define BOARD_LCD_SPI_DATA_LEN_IN_BITS  (8U)
#define BOARD_LCD_SPI_RX_DMA            HPM_DMA_SRC_SPI0_RX
#define BOARD_LCD_SPI_TX_DMA            HPM_DMA_SRC_SPI0_TX
#define BOARD_LCD_SPI_CS_GPIO_CTRL      HPM_GPIO0
#define BOARD_LCD_SPI_CS_PIN            IOC_PAD_PA06
#define BOARD_LCD_SPI_CS_ACTIVE_LEVEL   (0U)
...
void board_timer_us_create(uint32_t us, board_timer_cb cb);
